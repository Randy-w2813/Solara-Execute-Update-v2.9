...
[![Stars](https://img.shields.io/github/stars/Solara-Execute-Update-v2.9?style=flat-square)](https://github.com)
...
git clone https://github.com/Solara-Execute-Update-v2.9.git
cd Solara-Execute-Update-v2.9
